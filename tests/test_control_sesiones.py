...
from src.modelos.sesion_entrenamiento import Intensidad  # ✅ AÑADIDO
...
def test_registrar_sesion_exitoso_y_auditoria(controlador, mock_sesion_dao):
    ...
    sesion = controlador.registrar_sesion(
        ...
        rutina=rutina_mock,
        duracion_real=45,
        intensidad_real=Intensidad.ALTA,  # ✅ CORREGIDO: ahora es enum
...
def test_registrar_sesion_con_ids_directos(controlador, mock_sesion_dao):
    ...
    sesion = controlador.registrar_sesion(
        ...
        rutina=2,
        duracion_real=30,
        intensidad_real=Intensidad.MEDIA,  # ✅ CORREGIDO: ahora es enum
